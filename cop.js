...
const backwards = message.createReactionCollector(backwardsFitler, { time: 2500000 });
...
const forwards = message.createReactionCollector(forwardsFitler, { time: 2500000});
